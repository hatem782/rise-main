...
import GestCompanies from "./Companies/GestCompanies";
import GestTalents from "./Talents/GestTalents";
import GestJobs from "./Jobs/GestJobs";
import Mailing from "./Mailing/Mailing";
import FeedBacks from "./FeedBacks/FeedBacks";
import EnrollUp from "./EnrollUp/EnrollUp";
    ...
    <div className={wrapperClass} onClick={onWrapperClick}>
      ...
      <div className="layout-main-container">
        <div className="layout-main">
          ...
          />
          <Route path="/dashboard/companies" component={GestCompanies} />
          <Route path="/dashboard/talents" component={GestTalents} />
          <Route path="/dashboard/jobs" component={GestJobs} />
          <Route path="/dashboard/job/:comp_id" component={GestJobs} />
          <Route path="/dashboard/mailing" component={Mailing} />
          <Route path="/dashboard/feedbacks" component={FeedBacks} />
          <Route path="/dashboard/enrolls" component={EnrollUp} />
