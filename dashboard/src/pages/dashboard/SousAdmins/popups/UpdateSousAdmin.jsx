...
import { UpdateSousAdminValidation } from "./validation";
import useWindowSize from "../../../../hooks/useWindowSize";
import { UpdateSousAdminByAdmin } from "../../../../redux/sousadmins/sousadmins.actions";
...
function UpdateSousAdmin(props) {
  const { open, handleClose, title = "Updating Sous Admin", value } = props;
  ...
  const handleSubmit = () => {
    if (UpdateSousAdminValidation(item)) {
      dispatch(UpdateSousAdminByAdmin(item, handleClose));
    }
  };
