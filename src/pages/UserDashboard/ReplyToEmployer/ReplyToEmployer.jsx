...
import { current, others, unread, text, text2 } from "./fatedata";
    ...
    <div className={styles["main"]}>
      ...
      <div className={styles["content"]}>
        <div className={styles["part1"]}>
          <h1 className={styles["main-title"]}>Messages and Notifications</h1>
          ...
          {discs.map((item, key) => {
            return (
              <UserMail
                ...
                isTalent={false} // this is gonna render a company
              />
            );
          })}
              ...
              {messages.map((message, key) => {
                return (
                  <div
                    key={key}
                    className={
                      message.UserType === "User" ? styles.right : styles.left
                    }
                  >
                    <p>{message.content}</p>
                  </div>
