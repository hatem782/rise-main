      ...
      <div className={styles["navbar"]}>
        ...
        <div className={styles["links"]}>
          ...
          <span
            className={`
            ${styles["link"]} 
            ${current === "/jobs_internship" ? styles["current"] : ""}
            `}
          >
        ...
        {!isCompany && !isTalent && (
          ...
          >
            ...
            {isCompany ?             <span className={styles["post-job"]} onClick={_ => navigate('/emp_post_job')}>Post a Job</span>
:             <span className={styles["post-job"]} onClick={_ => navigate('/emp_cre_acc_comp_prof')}>Post a Job</span>
}
          </div>
        )}
        ...
        {isCompany && (
          <div className={`${styles["links"]} ${styles["links2"]}`}>
            ...
            <span className={styles["post-job"]} onClick={PostJob}>
              Post a Job
            </span>
          </div>
        )}
