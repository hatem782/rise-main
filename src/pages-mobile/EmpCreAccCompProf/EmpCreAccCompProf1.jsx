...
import PopupWithText from "../../pages/Popups/PopupWithText/PopupWithText";
import InputMobile from "../../components/inputs-mobile/Input";
import SelectMobile from "../../components/inputs-mobile/Select";

function EmpCreAccCompProf1Mobile() {
  return (
    <div>
      <Content />
    </div>
          ...
          {({ handleSubmit, values }) => (
            ...
            >
              ...
              <div className={styles["terms"]}>
                ...
                <span>
                  I agree to the Rise{" "}
                  <span className={styles["orange"]}>Terms of use</span> and{" "}
                  <span className={styles["orange"]}>Privacy Policy</span>
                </span>
              </div>
...
export default EmpCreAccCompProf1Mobile;
